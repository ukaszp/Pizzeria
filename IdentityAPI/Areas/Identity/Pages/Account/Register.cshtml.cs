...
namespace IdentityAPI.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            IUserStore<IdentityAPIUser> userStore,
        ...
        private IdentityAPIUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<IdentityAPIUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(IdentityAPIUser)}'. " +
                    $"Ensure that '{nameof(IdentityAPIUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
